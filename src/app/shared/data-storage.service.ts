...
export class DataStorageService {
  constructor(private http: HttpClient, private trainingService: TrainingsService) {}
  ...
  fetchTrainings() {
    this.http
      .get<Training[]>('https://my-training-tracker-default-rtdb.europe-west1.firebasedatabase.app/trainings.json')
      .pipe(map(trainings => { //rxjs
        return trainings.map(training =>{ //array operator
          return {...training,
